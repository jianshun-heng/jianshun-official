...
The plot below comes about when we exchange the country names given to us originally to "Germany", "Netherlands" and "China". For aesthetics purposes we did not copy and paste the code snippets again; we just inserted a png that we created.

```{r gdp-ours, out.width="100%"}
#this is a plot when exchanging the country names given to us originally to "Germany", "Netherlands" and "China". For aesthetics purposes we did not copy and paste the code snippets again; we just inserted a png that we created.
...
-   What, if anything, gave you the most trouble: [It was difficult to marry the logic behind problem solving to actual coding for certain portions. As this was the homework where our group used Github to collaborate, we had some issues merging our document versions and ended up with a very messy shared repository. #rip-repo-of-alex]{.underline}
